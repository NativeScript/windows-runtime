...
```
In GitHub, send a Pull Request to NativeScript:windows-runtime:master.
...
Use [Clang Format](Tools/git-clang-format) to check your code on every commit. There is also a [Visual Studio extension](http://clang.llvm.org/docs/ClangFormat.html#visual-studio-integration) available.
