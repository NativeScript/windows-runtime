...
public:
    TEST_METHOD(InOutParameter) {
        ...
        shared_ptr<MethodDeclaration> method{dynamic_pointer_cast<MethodDeclaration>(declaration->findMembersWithName(L"InOutParameter")[0])};
        ...
        Assert::IsTrue(inParameter.fullName() == L"NativeScript.Tests.Fixtures.MarshalingClass.InOutParameter.inParameter");
        ...
        Assert::IsTrue(outParameter.fullName() == L"NativeScript.Tests.Fixtures.MarshalingClass.InOutParameter.outParameter");
