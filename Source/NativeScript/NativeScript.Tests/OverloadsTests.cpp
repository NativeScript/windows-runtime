...
public:
    TEST_METHOD(MethodOverloads) {
        ...
        vector<shared_ptr<MethodDeclaration>> methods{declaration->findMethodsWithName(L"Method")};
        ...
        shared_ptr<MethodDeclaration> methodWithDouble{declaration->findMethodsWithName(L"MethodWithDouble")[0]};
        ...
        shared_ptr<MethodDeclaration> methodWithInt{declaration->findMethodsWithName(L"MethodWithInt")[0]};
